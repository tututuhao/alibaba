package com.alibaba.gateway.util;
...
public class JwtOperator {
    ...
    public static void main(String[] args) {
        ...
        // 将我改成上面生成的token!!!
        String someToken = "eyJhbGciOiJIUzI1NiJ9.eyJpZCI6IjEiLCJpYXQiOjE2NTAxOTY3NTcsImV4cCI6MTY1MTQwNjM1N30.n3bRXBIJ4M-ZV-ld7h9aeFHIKpYJe4eFHjoSIHWQ4is";
        ...
        String encodedPayload = "eyJpZCI6IjEiLCJpYXQiOjE2NTAxOTY3NTcsImV4cCI6MTY1MTQwNjM1N30";
        // 测试5: 解密Payload
        byte[] payload = Base64.decodeBase64(encodedPayload.getBytes());
        System.out.println(new String(payload));

        // 测试6: 这是一个被篡改的token，因此会报异常，说明JWT是安全的
        jwtOperator.validateToken("eyJpZCI6IjEiLCJpYXQiOjE2NTAxOTY3NTcsImV4cCI6MTY1MTQwNjM1N30a");
    }
}